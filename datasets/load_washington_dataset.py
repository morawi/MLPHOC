...
def load_wg_data(cf):
    ...
    for line in text_lines:
        ...
        has_alphabets = re.search('[a-zA-Z]', word_string) # if at leas has one alphabet
        if has_alphabets != None:
            word_id.append(id)
...
class WashingtonDataset(Dataset):
    ...
    def __init__(self, cf, train=True, transform=None, data_idx = np.arange(1), complement_idx=False):
        ...
        Args:
            ...
            the data_idx generated by the train_set should be passed to the ctest_the_modellass 
        ...
        time.sleep(1)
        print('\n Storing PHOCs for GW ', 'train' if train==True else 'test' ); # print(end='')
        time.sleep(1)
