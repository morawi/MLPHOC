...
def test_text_to_background(data_set):
    '''
...
# cf.dataset_name = 'IAM'; data_set  = IAM_words(cf, mode='validate', transform = None, augmentation = False )
# thin_img = ImageThinning(img)

# find_max_HW_in_data(data_set)
# test_text_to_background(data_set)
