...
keep_non_alphabet_in_GW  = True  # if True, it will be used in the analysis, else, it will be skipped from the phoc, even if has been loaded  
...
rnd_seed_value               =  int(time.time())  #  0 # time.time() should be used later
...
dataset_path_IFN             = folder_of_data + 'ifnenit_v2.0p1e/data/set_b/bmp/' # path to IFN images
gt_path_IFN                  = folder_of_data + 'ifnenit_v2.0p1e/data/set_b/tru/' # path to IFN ground_truth
